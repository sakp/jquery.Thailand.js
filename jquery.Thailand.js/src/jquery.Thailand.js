...
jQuery( function( $ ) {
    ...
    $.Thailand = function (options) {
        ...
        var ch_mapping = {'ก': 'A','ข': 'B','ฃ': 'C','ค': 'D','ฅ': 'E','ฆ': 'F','ง': 'G','จ': 'H','ฉ': 'I','ช': 'J','ซ': 'K','ฌ': 'L','ญ': 'M','ฎ': 'N','ฏ': 'O','ฐ': 'P','ฑ': 'Q','ฒ': 'R','ณ': 'S','ด': 'T','ต': 'U','ถ': 'V','ท': 'W','ธ': 'X','น': 'Y','บ': 'Z','ป': 'a','ผ': 'b','ฝ': 'c','พ': 'd','ฟ': 'e','ภ': 'f','ม': 'g','ย': 'h','ร': 'i','ล': 'j','ว': 'k','ศ': 'l','ษ': 'm','ส': 'n','ห': 'o','ฬ': 'p','อ': 'q','ฮ': 'r','๑': 's','๒': 't','๓': 'u','๔': 'v','๕': 'w','๖': 'x','๗': 'y','๘': 'z'};
        ...
        var preprocess = function (data) {
                ...
                t = function (text) {
                    ...
                    function repl_th(m){
                        var ch = ch_mapping[m].charCodeAt(0);
                        return words[ch < 97 ? ch - 65 : 26 + ch - 97];
                    }
                    ...
                    if(options.language == 'th'){
                        return text.replace(/[กขฃคฅฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรลวศษสหฬอฮ๑๒๓๔๕๖๗๘]/ig, repl_th);
                    }else{
            ...
            loadDB = function (callback) {
                ...
                if(options.language == 'en'){
                    options.database = options.database_en;
                }
    ...
    $.Thailand.defaults = {
        ...
        database_en: 'https://earthchie.github.io/jquery.Thailand.js/jquery.Thailand.js/database/db_en.json',
